...
export default function Home() {
    ...
    return (
        ...
        <section className="testimonial-one testimonial-page">
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="testimonial-one__single">
                            ...
                            <div className="testimonial-one__content">
                                ...
                                <div className="testimonial-one__client-info">
                                    <h3><Link href="testimonials">Obed McCoy</Link></h3>
                                    <p>Co-founder</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="testimonial-one__single">
                            ...
                            <div className="testimonial-one__content">
                                ...
                                <div className="testimonial-one__client-info">
                                    <h3><Link href="testimonials">Wade Barent</Link></h3>
                                    <p>Manager</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="testimonial-one__single">
                            ...
                            <div className="testimonial-one__content">
                                ...
                                <div className="testimonial-one__client-info">
                                    <h3><Link href="testimonials">Asle Rose</Link></h3>
                                    <p>Co-founder</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-xl-6 col-lg-6 col-md-6">
                        <div className="testimonial-one__single">
                            ...
                            <div className="testimonial-one__content">
                                ...
                                <div className="testimonial-one__client-info">
                                    <h3><Link href="testimonials">Kevin Piter</Link></h3>
                                    <p>Manager</p>
                                </div>
                            </div>
                        </div>
